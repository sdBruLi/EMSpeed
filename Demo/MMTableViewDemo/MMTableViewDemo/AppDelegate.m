...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    MMMenuController *menuVC = [[MMMenuController alloc] initWithStyle:UITableViewStylePlain];
    
    UINavigationController *nav = [[UINavigationController alloc] initWithRootViewController:menuVC];
    
    
//    MMInfoViewController *vc = [[MMInfoViewController alloc] init];
//    MMVIPTableController *vc = [[MMVIPTableController alloc] init];
