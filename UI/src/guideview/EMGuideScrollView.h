...
typedef void(^EMGuidScrollCompletion)(void);

/**
 *  滚动引导视图
 */
@interface EMGuideScrollView : UIScrollView<UIScrollViewDelegate>
{
    NSArray *_items;
    NSArray *_cells;
}

@property (nonatomic, strong) EMGuidScrollCompletion completion;
