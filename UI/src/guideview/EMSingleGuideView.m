...
@implementation EMSingleGuideView
...
+ (EMSingleGuideView *)showSingleGuideViewInWithItems:(NSArray *)items
                                               inView:(UIView *)view
{
    EMSingleGuideView *guidView = [[EMSingleGuideView alloc] initWithItems:items];
...
+ (EMSingleGuideView *)showSingleGuidViewWithitems:(NSArray *)array
                                            inView:(UIView *)view
                              dismissAutomatically:(BOOL)automatic
                                        completion:(void (^)(void))completion
{
    EMSingleGuideView *guidView = [EMSingleGuideView showSingleGuideViewInWithItems:array inView:view];
